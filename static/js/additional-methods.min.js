...
!function (a) {
    ...
    !function () {
    ...
    }, "Your ZIP-code must be in the range 902xx-xxxx to 905xx-xxxx"), a.validator.addMethod("isMobile", function (value, element) {
        var length = value.length;
        var mobile = /^1([3578]\d|4[57])\d{8}$/;
        return this.optional(element) || (length == 11 && mobile.test(value))
    }, "请正确填写您的手机号码"), a.validator.addMethod("isMobileSimp", function (value, element) {
        var length = value.length;
        var mobile = /^1\d{10}$/;
        return this.optional(element) || (length == 11 && mobile.test(value))
    }, "请正确填写您的手机号码"), a.validator.addMethod("isPhone", function (value, element) {
        var length = value.length;
        var mobile = /^([0-9]{1,4}-?)?\d{1,15}$/;
        return this.optional(element) || length <= 20 && (mobile.test(value))
    }, "请正确填写您的电话号码"), a.validator.addMethod("isFourNum", function (value, element) {
        var tel = /^[0-9]{4}$/;
        return this.optional(element) || (tel.test(value))
    }, "只能是四位数字"), a.validator.addMethod("isChar", function (value, element) {
        var length = value.length;
        var regName = /[^\u4e00-\u9fa5]/;
        return this.optional(element) || !regName.test(value)
    }, "请正确格式的姓名(暂支持汉字)"), a.validator.addMethod("isIdCardNo", function (value, element) {
        return this.optional(element) || idCardNoUtil.checkIdCardNo(value)
    }, "请正确输入您的身份证号码"), a.validator.addMethod("english", function (value, element) {
        var reg = /[^\x00-\xff]/;
        var chrnum = /^[[0-9a-zA-Z\s]+$/;
        return this.optional(element) || (chrnum.test(value) && !reg.test(value))
    }, "只能输入字母或半角的空格"), a.validator.addMethod("isZipCode", function (value, element) {
        var tel = /^[0-9]{6}$/;
        return this.optional(element) || (tel.test(value))
    }, "请正确填写您的邮政编码"), a.validator.addMethod("ip", function (value, element) {
        var ip = /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/;
        return this.optional(element) || (ip.test(value) && (RegExp.$1 < 256 && RegExp.$2 < 256 && RegExp.$3 < 256 && RegExp.$4 < 256))
    }, "Ip地址格式错误"), a.validator.addMethod("chinese", function (value, element) {
        var chinese = /^[\u4e00-\u9fa5]+$/;
        return this.optional(element) || (chinese.test(value))
    }, "只能输入中文"), a.validator.addMethod("forbidChinese", function (value, element) {
        var reg = /[^\x00-\xff]/;
        return this.optional(element) || !reg.test(value)
    }, "禁止输入中文"), a.validator.addMethod("positiveInteger", function (value, element) {
        var positiveInteger = /^[1-9]\d*$/;
        return this.optional(element) || (positiveInteger.test(value))
    }, "只能输入正整数"), a.validator.addMethod("digitsOrEnglish", function (value, element) {
        var digitsOrEnglish = /^([a-zA-Z0-9]{5})$/;
        return this.optional(element) || (digitsOrEnglish.test(value))
    }, "只能输入字母或者数字并且必须为5位"), a.validator.addMethod("digitsOrChinese", function (value, element) {
        var digitsOrChinese = /^[\u4e00-\u9fa5\d\s]+$/;
        return this.optional(element) || (digitsOrChinese.test(value))
    }, "只能输入中文数字或空格"), a.validator.addMethod("ChineseLength", function (value, element, params) {
        var flag = true;
    ...
    }, "超出长度限制"), a.validator.addMethod("fullWidth", function (value, element, params) {
        var flag = false;
        var flag = true;
        var myArray = new Array()
        //计算字符串长度
        var strRealLenth = value.replace(/[^\x00-\xff]/g, "xx").length
        ...
        //alert(strRealLenth);
        //判断是否长度查过最大长度
        if(strRealLenth > params[0]){
            flag = false
        }
        return this.optional(element) || flag
    }, "超出长度限制"), a.validator.addMethod("halfWidth", function (value, element) {
        var flag = false;
        var full = /[\uff00-\uffff]/g;
        var res = full.test(value)
        if (!res) {
            flag = true;
        } else {
            flag = false;
